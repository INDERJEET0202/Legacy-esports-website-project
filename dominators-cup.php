        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/dominators-cup-1.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/dominators-cup-2.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/logo-4.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Organized by</strong>: ESPORTSWALA</li>
                <li><strong>Managed by</strong>: TEAMLEGACY ESPORTS</li>
                <li><strong>Prizepool</strong>: 2,500 INR</li>
                <li><strong>Slots</strong>: 200+</li>
                ...
                <!-- <li><strong>Promotional Link</strong>: <a href="https://www.youtube.com/watch?v=V6N1UDL-srU">www.youtube/esportswala.com</a></li> -->
                <li><strong>Finals Stream Link</strong>: <a href="https://www.youtube.com/watch?v=oizv071DPUU" target="_blank">www.youtube/esportswala.com</a></li>
                <li><strong>Status </strong>: Finished.</li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>FreeFire Dominators Cup Details</h2>
              <p>
                <strong> Dominators Cup </strong> presented to you by <strong> ESORTSWALA </strong> with a total prizemoney of 2,500 INR. Tournament is totally managed by <strong> TEAMLEGACY </strong> ESPORTS. Registrations process are very simple. Registration will be over our discord server, don't forget to join and participate.
              </p>
            </div>
          </div>
