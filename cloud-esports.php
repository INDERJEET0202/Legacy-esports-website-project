        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/warzone-1.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/warzone-2.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/logo-7.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            ...
            <h3>Tournament Information</h3>
              <ul>
                <li><strong>Organized by</strong>: MASTERPIECE ESPORTS PRESENT</li>
                <li><strong>Powered by</strong>: COMMUNITY GAMING</li>
                <li><strong>Prizepool</strong>: 13,000 INR</li>
                <li><strong>Slots</strong>: 120+</li>
                ...
                <!-- <li><strong>How to register?</strong> <a href="https://www.youtube.com/watch?v=La08W4ETN1c">www.youtube/teamlegacyesports.com</a></li>
            ...
            <div class="portfolio-description">
              <h2>FreeFire Warzone Details</h2>
              <p>
                <strong> FREEFIRE CHAMPIONSHIP </strong> presented to you by <strong> MASTERPIECE ESPORTS PRESENT </strong> with a total prizemoney of 13,000 INR, powered by <strong>COMMUNITY GAMING</strong> with total of 120+ slots. We will provide league customs at FINALS along with drone views will be live streamed in our youtube channel. We are inviting your favourite teams to play against you, Have fun. And for more information <a href="https://discord.gg/TJGkZz96dJ" target="_blank">click here </a> to Join our Discord server..
              </p>
            </div>
          </div>
