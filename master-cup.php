        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/master-cup.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/mastercup3.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/logo-6.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Organized by</strong>: TEAM MASTERPIECE</li>
                <li><strong>Sponsored by</strong>: COMMUNITY GAMING</li>
                <li><strong>Prizepool</strong>: 15,000 INR</li>
                <li><strong>Slots</strong>: 256+</li>
                <li><strong>Entry </strong>: Free</li>
                <li><strong>Mode </strong>: Squad</li>
                <li><strong>Tournament starts </strong>: 16th AUGUST</li>
                <li><strong>Platform </strong>: IOS/Android</li>
                <li><strong>Region </strong>: India Nepal</li>
                <li><strong>Join Discord</strong>- <a href="https://discord.gg/8TwaYEpmhP">www.discord.gg/TMR</a></li>
                <!-- <li><strong>How to register?</strong> <a href="https://www.youtube.com/watch?v=RO1W7BH-IVQ" target="_blank">www.youtube/skullgaming.com</a></li> -->
                <li><strong>Status </strong>: Running..</li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>FreeFire Master Cup Season 1 Details</h2>
              <p>
                <strong> FreeFire Master Cup Season 1 </strong> presented to you by <strong> TEAM MASTERPIECE </strong> with a total prizemoney of 15,000 INR. Regiatration starts from 1st August to 16th August. Matches will be live streamed on youtube. Dont forget to register. And for more information <a href="https://discord.gg/8TwaYEpmhP" target="_blank">click here </a> to Join our Discord server..
              </p>
            </div>
          </div>
