        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/infinity-series.png" alt="">
                </div>
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/logo-2.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Organized by</strong>: TEAMLEGACY ESPORTS</li>
                <li><strong>Powered by</strong>: COMMUNITY GAMING</li>
                <li><strong>Prizepool</strong>: 15,000 INR</li>
                <li><strong>Slots</strong>: 500+</li>
                ...
                <li><strong>Region </strong>: India Nepal Bangladesh</li>
                <li><strong>Promotional link</strong>: <a href="https://www.youtube.com/watch?v=O137mZZUEjA">www.youtube/teamlegacyesports.com</a></li>
                <li><strong>Register Now</strong>- <a href="https://discord.gg/Fd6EwQv6kA" target="_blank">www.discord.gg/tles</a></li>
                <li><strong>Status </strong>: Running..</li>
            </ul>
            </div>
            <div class="portfolio-description">
              <h2>FreeFire Infinity Series Details</h2>
              <p>
                <strong> FreeFire Infinity Series </strong> presented to you by <strong> TEAMLEGACY ESORTS </strong> with a total prizemoney of 15,000 INR, powered by <strong>COMMUNITY GAMING</strong> with total of 500+ slots. We will provide league customs at FINALS along with drone views will be live streamed in our youtube channel.No emulators allowed. We are inviting your favourite teams to play against you, Have fun. And for more information <a href="https://discord.gg/Fd6EwQv6kA" target="_blank">click here </a> to Join our Discord server..
              </p>
            </div>
          </div>
