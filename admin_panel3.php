  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h3 style="font-family: 'Poppins';" >You are logged in as Admin</h3>
    ...
    <section class="inner-page">
      <div class="container">
        <p>
        This is admin pannel. Welcome <?php echo $_SESSION['AdminLoginId']; ?>
        </p>
        <h1> Content here</h1>
  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-6 footer-links">
        <h4>Links</h4>
        <ul>
          <li><i class="bi bi-chevron-right"></i> <a href="tournaments.php">Tournaments</a></li>
