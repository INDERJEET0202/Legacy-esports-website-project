...
<head>
    ...
    <title>TeamLegacy Esports - Email Recovery</title>
...
$token = $userdata['token'];
	...
	$template_file = "./email_templates/template_recover_email.php";
	...
	$swap_var = array(
		...
		"{CUSTOM_URL}" => "http://localhost/TeamLegacy%20-%20Copy/reset_password.php?token=$token ",
	...
	if ( mail($email_to, $email_subject, $email_message, $email_headers) ) {
                    ...
                    <strong>Hey!</strong> We have sent you a password reset link to your e-mail '. $email . '. Please check your inbox.  
                    ...
                    <strong>Error!</strong> Email sending failed !!
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div> ';
                ...
                echo ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Error!</strong> No valid Email found.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div> ';
                    ...
                    <article class="card-body mx-auto" style="max-width: 400px;">
                        ...
                        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" class="btn btn-primary btn-block"> Reset Password
                                </button>
                            </div> <!-- form-group// -->
            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-2 col-6 footer-links">
                        <h4>Links</h4>
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <a href="index-page.html">Tournaments</a>
                            </li>
