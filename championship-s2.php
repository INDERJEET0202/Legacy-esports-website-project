            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/championship-s2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/championship-s2-2.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/champpionship-s2.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Powered by</strong>: ROOTER</li>
                <li><strong>Prizepool</strong>: 15,000 INR</li>
                <li><strong>Slots</strong>: 2000+</li>
                ...
                <li><strong>How to register?</strong> <a href="https://discord.gg/Fd6EwQv6kA">JOIN DISCORD</a></li>
                ...
                <li><strong>Status </strong>: Strting Soon..</li>
            </ul>
            </div>
            <div class="portfolio-description">
              <h2>FreeFire Champions League season2 Details</h2>
              <p>
                <strong> FREEFIRE CHAMPIONSHIP season 2</strong> presented to you by <strong> LEGACY ESORTS </strong> with a total prizemoney of 15,000 INR, powered by <strong>ROOTER</strong> with total of 2000 slots. We will provide league customs at FINALS along with drone views will be live streamed in our youtube channel. We are inviting your favourite teams to play against you, Have fun. And for more information <a href="https://discord.gg/Fd6EwQv6kA" target="_blank">click here </a> to Join our Discord server..
              </p>
            </div>
          </div>
