  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="index.php#hero" style="
          padding-right: 30px;
      " >HOME</a></li>
          ...
          <li class="dropdown"><a href="#"><span>TOURNAMENT</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="index.php#services">Our Games</a></li>
              <li><a href="inner-page.php">Running Tournaments</a></li>
              <li><a href="index.php#portfolio">Past Tournaments</a></li>
            </ul>
          </li> 
           ...
           <!-- <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="#"><span>Deep Drop Down</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="inner-page.php">Deep Drop Down 1</a></li>
          ...
          <li><a class="signup" href="regis.php">SIGNUP</a></li>
        </ul>
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-6 footer-links">
        ...
        <ul>
          ...
          <li><i class="bi bi-chevron-right"></i> <a href="index.php#services">Our Games</a></li>
      ...
      <div class="col-lg-2 col-6 footer-links">
        <h4>Links</h4>
        <ul>
          <li><i class="bi bi-chevron-right"></i> <a href="index.phpinner-page.html">Tournaments</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="index.php#portfolio">Previous Tournaments</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="index.php#team">Team</a></li>
          <li><i class="bi bi-chevron-right"></i> <a href="index.php#faq">F.A.Q</a></li>
