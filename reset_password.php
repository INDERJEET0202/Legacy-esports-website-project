...
<head>
  ...
  <title>TeamLegacy Esports - Reset Password</title>
    ...
    $cpass = password_hash($cpassword, PASSWORD_BCRYPT);
        ...
        $updatequery = " update registration set password= '$pass' where token = '$token'";
            ...
            if($iquery){
                ...
                <strong>Error!</strong> Your password has been updated...
                ...
                $_SESSION['passmsg'] = ' <div class="alert alert-danger alert-dismissible fade show" role="alert">
            ...
            $_SESSION['passmsg'] =' <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Error!</strong> Passwords are not matching, please recheck.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div> ';
            // echo "Passwords are not matching please recheck";
        }
        ...
        ?> </p>
            ...
            <form action="" method="POST">
                ...
                <div class="form-group input-group">
                    ...
                    <input class="form-control" placeholder="Create a new password" name="password" type="password"
                        required>
                </div> <!-- form-group// -->
                <div class="form-group input-group">
                    <div class="input-group-prepend">
