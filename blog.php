...
<head>
  ...
  <title>TeamLegacy Esports - Blog</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/img/blog/freefire-4th_aniversary.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="blog-single">Garena Free Fire 4th anniversary event: Check DATE, events details, rewards, giveaways, and more.</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single">ZeeBiz WebTeam</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single"><time datetime="2020-01-01">Aug 19, 2021</time></a></li>
              ...
              <div class="entry-content">
                <p>
                Free Fire 4th anniversary: One of the most popular Battle Royale games Garena Free Fire is so close to its 4th anniversary. 
                The game has always provided gamers an amazing gameplay experience and rewards. This time, Garena has come up with 4th-anniversary events to celebrate Free Fire’s four years of completion.
                </p>
                <div class="read-more">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/img/blog/character.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="blog-single">Thiva character in Free Fire: Abilities, how to get, and best pet combinations.</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single">John Doe</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single"><time datetime="2020-01-01">Thru, August 19</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-single">12 Comments</a></li>
                </ul>
              </div>
...
More importantly, Thiva being a passive character, can be easily incorporated into character combinations with other active characters like Alok, Chrono, and K.
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/img/blog/reunion.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="blog-single">Alok and KSHMR return to collaborate with Dimitri Vegas & Like Mike for Free Fire’s 4th-anniversary celebrations</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single">TLEs team</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-single"><time datetime="2020-01-01">Aug 1, 2020</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-single">12 Comments</a></li>
                </ul>
              </div>
              ...
              <div class="entry-content">
                <p>
                Globally renowned DJs Dimitri Vegas & Like Mike, Alok, and KSHMR have come together for Free Fire’s 4th-anniversary theme song, “Reunion.”
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li><a href="#">Game <span>(12)</span></a></li>
                  <li><a href="#">Freefire <span>(5)</span></a></li>
                  <li><a href="#">eSports <span>(22)</span></a></li>
                  <li><a href="#">Creative <span>(8)</span></a></li>
                  <li><a href="#">Career <span>(14)</span></a></li>
                </ul>
