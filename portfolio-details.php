        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/portfolio/chamions-league-1.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/champions-league-2.jpg" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/chamions-league-3.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/portfolio/logo-1.png" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Prizepool</strong>: 4,000 INR</li>
                ...
                <li><strong>Promotional Link</strong>: <a href="https://www.youtube.com/watch?v=V6N1UDL-srU" translate="_blank">www.youtube/teamlegacyesports.com</a></li>
                <li><strong>Finals Stream Link</strong>: <a href="https://www.youtube.com/watch?v=jXen0leNxRg" translate="_blank">www.youtube/teamlegacyesports.com</a></li>
                <li><strong>Status </strong>: Finished.</li>
              </ul>
            </div>
            <div class="portfolio-description">
              <h2>FreeFire Champions League Details</h2>
              <p>
                TeamLegacy Esports is back again with another FreeFire Tournament with a Grand Prizepool of 4000/- INR. Tournament will be managed by TeamLegacy Esports itself. Registrations process are very simple. Registration will be over our <a href="https://discord.gg/Fd6EwQv6kA" target="_blank"> Discord</a> server, don't forget  to join and participate.
              </p>
            </div>
          </div>
