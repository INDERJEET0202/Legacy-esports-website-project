...
<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if (isset($_POST['submit'])){
        ...
        $newuid = mysqli_real_escape_string($con, $_POST['uid']);
        $newbio = mysqli_real_escape_string($con, $_POST['bio']);
        $newign = mysqli_real_escape_string($con, $_POST['ign']);

        

        $updatequery = " update registration set `username` = '$newusername', `mobile` ='$newmobile', `bio` = '$newbio' , `uid` = '$newuid', `ign` = '$newign' where `email` = '$email' ";
...
?>
        ...
        <div class="card bg-light">
            <article class="card-body mx-auto" style="max-width: 400px;">
                <h4 class="card-title mt-3 text-center">Account Settings</h4>
                <p class="text-center"> <strong> Note </strong>: You cannot change your Email ID.</p>
                <p>
                <form action = "<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group input-group">
                        ...
                        <input name="username" class="form-control" placeholder="USERNAME" value="<?php echo $_SESSION['username']; ?>"  type="text" required >
                      </div> <!-- form-group// -->
                      <div class="form-group input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
                        </div>
                        <input name="email" class="form-control" placeholder="<?php echo $_SESSION['email']; ?>"  type="email"  style="pointer-events: none;" >
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="mobile" class="form-control" placeholder="MOBILE" value="<?php echo $_SESSION['mobile']; ?>" type="text" required >
                    </div> <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"> <i class="fas fa-gamepad"></i> </span>
                        </div>
                        <input class="form-control" placeholder="UID" value="<?php echo $_SESSION['uid']; ?>" name = "uid"  type="text" required >
                    </div> 
                    <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                        ...
                        <input class="form-control" placeholder="IGN" value="<?php echo $_SESSION['ign']; ?>"  name = "ign" type="text" required >
                    </div>
                    <!-- form-group end.// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                        ...
                        <input class="form-control" placeholder="BIO" value="<?php echo $_SESSION['bio']; ?>" name = "bio"  type="text" required >
                    </div> 
                     <!-- form-group// -->
